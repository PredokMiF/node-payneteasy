            ...
            function (response) {
                if (response.err) {
                    ...
                    daoTransactionUpdate.update(data)
                        .then(function(){
                            daoTransactionStepCreate.create('return', response.data.data['serial-number'], data.transactionUuid, response.data.data['paynet-order-id'], data, null, response.data.data)
                        })
                        .then(function(){
