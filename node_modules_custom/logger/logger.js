...
function getLogerWrapper(logger, module) {
    return {
        debug: function (msg, cmnObj, userUuid, transactionUuid) {
            logger.log(
                'debug',
                convertMsg(msg),
                {
                    ...
                    cmn: (cmnObj instanceof Error) ? cmnObj.stack : cmnObj
                }
            )
        },

        info: function (msg, cmnObj, userUuid, transactionUuid) {
            logger.log(
                'info',
                convertMsg(msg),
                {
        ...
        warn: function (msg, cmnObj, userUuid, transactionUuid) {
            logger.log(
                'warn',
                convertMsg(msg),
                {
        ...
        error: function (msg, cmnObj, userUuid, transactionUuid) {
            logger.log(
                'error',
                convertMsg(msg),
                {
